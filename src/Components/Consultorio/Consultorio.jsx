            ...
            <div className='container-fluid'>
                <div className="row p-3">
                    <div className="col consult-left">
                        <p>
                            Mi consultorio se encuentra ubicado en Caseros, Tres de Febrero. Me complace ofrecer una atención médica de
                            excelencia solo con turno previo, para asegurarme de brindar el tiempo y la dedicación que cada paciente
                            merece.
                        </p>
                        ...
                        <p className='p-blue'>¡Contáctame ahora mismo y permíteme cuidar de tu corazón y tu salud en general! </p>
